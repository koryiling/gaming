...
(function () {
  ...
  const UI = {
    en: {
      ...
      recordTime: "🏆 Fastest: {time} by {name} — beat it!",
      recordLow: "🏆 Fewest: {n} tries by {name} — beat it!",
    ...
    ms: {
      ...
      recordTime: "🏆 Terpantas: {time} oleh {name} — pecahkannya!",
      recordLow: "🏆 Paling sedikit: {n} cubaan oleh {name} — pecahkannya!",
    ...
    zh: {
      ...
      recordTime: "🏆 最快：{time}（{name}）——来挑战吧！",
      recordLow: "🏆 最少：{n}次（{name}）——来挑战吧！",
      welcome: "欢迎，{name}！🌿",
      nameMin: "请至少输入 2 个字符。",
      changeName: "修改你的用户名：",
      nameUpdated: "用户名已更新 ✔",
