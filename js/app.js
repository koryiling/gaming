...
(function () {
  ...
  function renderRows(ol, list, metric, emptyMsg, catLabels) {
    ...
    list.forEach((e, i) => {
      ...
      // meta line: difficulty/category badge (e.g. Sudoku 🟢 Easy) + when achieved
  ...
  // fill one combined ranked list into the given <ol>; difficulty shows as a per-row badge
  function fillLBList(ol, gameId, emptyMsg, limit) {
    ...
    // single ranking; time metric sorts ascending in board.top — shortest time first
